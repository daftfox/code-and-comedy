...
angular.module('vtortola.ng-terminal', [])
  ...
  .provider('terminalConfiguration', function () {
    ...
    var config = function () {
      ...
      me.promptConfiguration = { end: ':>', user: 'fordprefect', separator: '@', path: 'cncreg\\' };
  ...
  .controller('terminalController', ['$scope', '$element', 'terminalConfiguration', 'promptCreator', function ($scope, $element, terminalConfiguration, promptCreator) {
    ...
    $scope.focusOnInput = function(){
      angular.element("#terminal-input").triggerHandler('click');
    }
  ...
  .directive('terminal', function ($document) {
    return {
      ...
      transclude: true,
      replace:true,
      template: "<section class='terminal' ng-click='focusOnInput()' ng-paste='handlePaste($event)'><div class='terminal-viewport'><div class='terminal-results'></div><span class='terminal-prompt' ng-show='showPrompt'>{{prompt.text}}</span><span class='terminal-input'>{{commandLine}}</span><span class='terminal-cursor'>_</span><input id='terminal-input' type='text' ng-model='commandLine' class='terminal-target' df-focus-on-me/></div><div ng-transclude></div></section>",
